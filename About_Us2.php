...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div>
            <center>
                <h1>Dallal for Education Services</h1>
                <h3>Every year we change the lives of thousands of students and families.<br/> We Let the students explore all the worldwide study opportunities from a single platform, <br/>and help them find the right study program that meets their needs, goals, and preferences. <br/>In order to succeed in this mission,<br/> we work with more than 400 universities, schools, and rehabilitation centers worldwide.</h3>
            </center>
        </div>
